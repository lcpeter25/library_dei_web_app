'''
This file exists because the original creator was just learning Django while creating this project and
wanted a quick reference. It is retained to help the next contributor in case they want it.
